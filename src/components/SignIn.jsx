        ...
        >
          ...
          <div className="flex flex-col mb-7 items-center">
            <div className="mailDiv flex flex-row gap-1 w-[80%] m-auto  border-1 border-slate-300 rounded-md pl-1 text-stone-400 fill-stone-400 cursor-pointer transition-all duration-100">
              ...
              <input
                className="w-full outline-0 border-0  cursor-pointer text-black"
                type="email"
          ...
          <div className="flex flex-col  gap-2.5">
            ...
            <button className="rounded-md  text-white hover:text-white pr-2.5 pl-2.5 pt-1.5 pb-1.5 w-[80%] m-auto text-center hover:shadow-xs shadow-green-700  cursor-pointer transition-all duration-100 bg-green-300 hover:bg-green-400 hover:scale-[1.02]">
